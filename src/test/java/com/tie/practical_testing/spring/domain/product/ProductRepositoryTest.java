package com.tie.practical_testing.spring.domain.product;
...
class ProductRepositoryTest {
    ...
    void findAllBySellingStatusIn() {
        // given
        Product product1 = createProduct("001", HANDMADE, SELLING, "아메리카노", 3000);
    ...
    @Test
    @DisplayName("가장 마지막으로 저장한 상품의 상품번호를 읽어올 때, 상품이 하나도 없는 경우에는 nuoll을 반환한다.")

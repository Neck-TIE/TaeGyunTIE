...
import com.tie.practical_testing.spring.api.controller.product.dto.request.ProductCreateRequest;
...
class ProductServiceTest {
    ...
    void createProduct() {
        // given
        Product product = createProduct("001", HANDMADE, SELLING, "아메리카노", 3000);
        ...
        assertThat(products).hasSize(2)
                ...
                .containsExactlyInAnyOrder(
                        tuple("001", HANDMADE, SELLING, "아메리카노", 3000),
